...
},{"./utils.js":"utils.js"}],"../node_modules/lit-html/lib/dom.js":[function(require,module,exports) {
"use strict";
...
},{"lit-element":"../node_modules/lit-element/lit-element.js"}],"components/Timer.js":[function(require,module,exports) {
"use strict";
...
var _BaseElement = _interopRequireDefault(require("./BaseElement.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

class Timer extends _BaseElement.default {
  static get styles() {
    return (0, _litElement.css)`
      ${super.styles}
      input {
  ...
  deleteTimer() {
    _State.default.deleteTimer(this.timer.id);
  }
  ...
  updateTimer(timer, update) {
    ...
    _State.default.updateTimer(timer.id, {
      title: title,
      length: newSecs * 1000 + newMins * 60 * 1000 + newHours * 60 * 60 * 1000
    });
  }
  ...
  render() {
    ...
    if (!this.editing) {
      time = (0, _utils.getTimerTime)(timer);
    }
    ...
    return (0, _litElement.html)`
      ...
      <div class="controls">
        ...
        <button class="big" @click="${e => this.playPauseTimer(timer)}">
          ${timer.state === 1 ? (0, _litElement.html)`<svg xmlns="http://www.w3.org/2000/svg" style="fill:#fff" width="55" height="66" viewBox="0 0 55 66"><g transform="translate(-0.056 -0.219)"><rect width="20" height="66" transform="translate(0.056 0.219)"/><rect width="20" height="66" transform="translate(35.056 0.219)"/></g></svg>` : (0, _litElement.html)`<svg xmlns="http://www.w3.org/2000/svg" style="fill:#fff" width="50" height="60" viewBox="0 0 50 60"><g transform="translate(-692.714 -1280.057)"><path d="M0,0,50,30h0L0,60Z" transform="translate(692.714 1280.057)"/></g></svg>`}          
        </button>
      </div>
    `;
  }
...
},{"lit-element":"../node_modules/lit-element/lit-element.js","../State.js":"State.js","../utils.js":"utils.js","./BaseElement.js":"components/BaseElement.js"}],"components/TimerCard.js":[function(require,module,exports) {
"use strict";
...
class TimerCard extends _litElement.LitElement {
  static get styles() {
    return (0, _litElement.css)`
      :host {
        display: block;
  ...
  render() {
    ...
    return (0, _litElement.html)`
      <div class="card-wrapper">
        <div class="timer">
          <div class="length">${(0, _utils.timeToString)(timer.length)}</div>
          <div class="current">${(0, _utils.timeToString)(time)}</div>
        </div>
...
},{"lit-element":"../node_modules/lit-element/lit-element.js","../utils.js":"utils.js"}],"components/TimerList.js":[function(require,module,exports) {
"use strict";
...
class TimerList extends _litElement.LitElement {
  static get styles() {
    return (0, _litElement.css)`
      :host {
        display: block;
...
},{"lit-element":"../node_modules/lit-element/lit-element.js","../State.js":"State.js"}],"components/Notification.js":[function(require,module,exports) {
"use strict";
...
require("./components/TimerCard.js");

require("./components/TimerList.js");
...
async function init() {
  ...
  mainElement.querySelector('[toggle-drawer]').addEventListener('click', e => closeDrawer());
  mainElement.querySelector('[create-timer]').addEventListener('click', e => _State.default.createTimer());
  window.addEventListener('statechange', async e => {
    const state = await _State.default.getState();
    const currentTimer = await _State.default.getTimerById(state.currentTimer);
...
},{"./State.js":"State.js","./components/Timer.js":"components/Timer.js","./components/TimerCard.js":"components/TimerCard.js","./components/TimerList.js":"components/TimerList.js","./components/Notification.js":"components/Notification.js","./sw.js":[["sw.js","sw.js"],"sw.js.map","sw.js"]}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
